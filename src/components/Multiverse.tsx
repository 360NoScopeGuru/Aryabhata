...
import { type Conversation, useAppStore } from '@/store/appStore'
      ...
      <div className="mv-modal" onClick={(e) => e.stopPropagation()}>
        <div className="mv-head">
          <div className="mv-title">
            ...
            <span className="mv-sub">
              {stats.total} sessions · {stats.roots} roots · {stats.forks} forks · max depth{' '}
              {stats.maxDepth}
            </span>
          </div>
          <input
          ...
          />
          <button className="mv-close" onClick={onClose}>
            ×
          </button>
        </div>
        ...
        <div className="mv-foot">
          ...
          <span style={{ marginLeft: 'auto' }}>
            <span className="mv-legend">
              <i style={{ background: MODE_COLORS.chat }} /> Chat
            </span>
            <span className="mv-legend">
              <i style={{ background: MODE_COLORS.code }} /> Code
            </span>
            <span className="mv-legend">
              <i style={{ background: MODE_COLORS.image }} /> Image
            </span>
          </span>
        </div>
      </div>
