    ...
    <aside className="rail-right">
      ...
      <div className="tele-block">
        <div className="tele-row">
          ...
          <div className="tele-kv">
            <span className="tk">
              CO₂ <span style={{ opacity: 0.5, fontSize: '8px' }}>est.</span>
            </span>
            <span className="tv">
              {telemetry.carbon.toFixed(1)}
              <sub>g</sub>
            </span>
          </div>
          <div className="tele-kv">
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
              <span
                style={{
                  ...
                  boxShadow: `0 0 8px ${activeModel.color}88`,
                  flexShrink: 0,
                }}
              />
      ...
      <div className="tele-block">
        ...
        {[
          ...
          {
            label: 'Freq Pen',
            val: frequencyPenalty.toFixed(2),
            min: 0,
            max: 2,
            step: 0.01,
            set: setFrequencyPenalty,
            cur: frequencyPenalty,
          },
          {
            label: 'Pres Pen',
            val: presencePenalty.toFixed(2),
            min: 0,
            max: 2,
            step: 0.01,
          ...
          <div className="tele-block">
            ...
            <div className="chip-row">
              {SIZES.map((s) => (
                <button
                  key={s.label}
                  className={`chip ${imageWidth === s.w && imageHeight === s.h ? 'on' : ''}`}
          ...
          <div className="tele-block">
            ...
            <div className="chip-row">
              {QUALITY.map((q) => (
                <button
                  key={q.label}
                  className={`chip ${imageSteps === q.steps ? 'on' : ''}`}
              ...
              <div key={e.model_id} className="lb-row">
                ...
                <div className="lb-bar-wrap">
                  <div
                    className="lb-bar"
                    style={{
                      width: `${e.win_rate * 100}%`,
                      background: info?.color ?? 'var(--accent)',
                    }}
                  />
                </div>
