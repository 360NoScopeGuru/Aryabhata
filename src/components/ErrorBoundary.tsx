  ...
  render() {
    ...
    return (
      <div style={{
        ...
        <div style={{ fontSize: '11px', letterSpacing: '.2em', textTransform: 'uppercase', color: 'var(--warn)' }}>
          Critical Error
        </div>
        <div style={{ fontSize: '9.5px', letterSpacing: '.1em', color: 'var(--ink-faint)', maxWidth: '480px', textAlign: 'center' }}>
          {error.message}
        </div>
        <button
